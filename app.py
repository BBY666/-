...
def HighStateHandler(msg: SportModeState_):
	...
	dog_data["position X"] = format(msg.position[0], ".2f")
	dog_data["position Y"] = format(msg.position[1], ".2f")
	dog_data["position Z"] = format(msg.position[2], ".2f")
	dog_data["imu_quaternion W"] = format(msg.imu_state.quaternion[0], ".2f")
	dog_data["imu_quaternion X"] = format(msg.imu_state.quaternion[1], ".2f")
	dog_data["imu_quaternion Y"] = format(msg.imu_state.quaternion[2], ".2f")
	dog_data["imu_quaternion Z"] = format(msg.imu_state.quaternion[3], ".2f")
	#dog_data["imu_quaternion Z"] = format(msg.imu_state.quaternion[3], ".2f")
...
def generate_data():
	while True:
		data_array = [
			...
			{'name': 'Position X', 'value': dog_data['position X']},
			{'name': 'Position Y', 'value': dog_data['position Y']},
			{'name': 'Position Z', 'value': dog_data['position Z']},
			{'name': 'imu_quaternion W', 'value': dog_data['imu_quaternion W']},
			{'name': 'imu_quaternion X', 'value': dog_data['imu_quaternion X']},
			{'name': 'imu_quaternion Y', 'value': dog_data['imu_quaternion Y']},
			{'name': 'imu_quaternion Z', 'value': dog_data['imu_quaternion Z']},
